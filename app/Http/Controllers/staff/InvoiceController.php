...
class InvoiceController extends Controller
{
    ...
    public function register($id)
    {
        ...
        $spps = Spps::all();
        return view('staff.bill.create', compact('student', 'spps'));
    }
    ...
    public function detail(User $user)
    {
        try {
            ...
            return view('staff.bill.detail', compact(
                'student',
                'tagihan',
                'summary',
                'tunggakan',
    ...
    { 
        ...
        return view('staff.management.payment.index', compact('payments'));
    }
    ...
    public function detailPayment($id)
    {
        ...
        return view('staff.payment.detail', compact('SppBulan'));
    }
